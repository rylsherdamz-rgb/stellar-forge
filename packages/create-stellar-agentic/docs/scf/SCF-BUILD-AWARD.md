...
| 1.2 | CLI + templates (contracts, frontend, backend, cicd) polished | Clean-environment scaffold works from docs alone | Fresh-environment reproduction recorded | $1,500 |
| 1.3 | Eval suites extended to payment + zk zones | x402 flow + contract-state eval suites pass | Test suite output in CI | $1,500 |
